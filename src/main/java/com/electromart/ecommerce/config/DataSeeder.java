...
/**
 * Seeds the products collection with the same 16 sample electronics used in the
 * Angular frontend, so the API returns real data immediately after startup.
 * Only runs when the "products" collection is empty. Also seeds a default admin
 * account (admin@electromart.com / Admin@123) if no admin exists yet.
 */
@Component
